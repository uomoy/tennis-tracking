...
#
game_list = ['hard', 'clay', 'grass']
p = '/home/porsche/dalhong/dataset_image/hard/frame/0.png'
...
for game in game_list:
	...
	# all_path = glob('/home/porsche/dalhong/Dataset/match1/frame/*')
	all_path = glob('/home/porsche/dalhong/dataset_image/' + game + '/frame/*')
...
for game in game_list:
	...
	#pp = p.split('/')
	#print("pp: ", pp[-1])
	labelPath = '/home/porsche/dalhong/dataset_image/' + game + '/csv/'+ game + '.csv' 
	...
	for i in range(num-2):
		...
		for j in range(3):
			target=str(no[i+j])
			print('target: ', target)
			png_path = '/home/porsche/dalhong/dataset_image/' + game + '/frame/' + target
